...
local function get_base()
	...
	return {
		...
		FoldColumn = { bg = cp.catppuccin14, fg = cp.catppuccin11 }, -- 'foldcolumn'
		SignColumn = { bg = cnf.transparent_background and cp.none or cp.catppuccin14, fg = cp.catppuccin12 }, -- column where |signs| are displayed
		...
		Normal = { fg = cp.catppuccin10, bg = cnf.transparent_background and cp.none or cp.catppuccin14 }, -- normal text
		NormalNC = { fg = cp.catppuccin10, bg = cnf.transparent_background and cp.none or cp.catppuccin14 }, -- normal text in non-current windows
		NormalSB = { fg = cp.catppuccin10, bg = cp.catppuccin14 }, -- normal text in non-current windows
